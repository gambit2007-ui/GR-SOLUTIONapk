            ...
            return (
              <article key={operation.id} className="rounded-2xl border border-zinc-900 bg-black p-4 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {operation.borrowerSignUrl && <button type="button" onClick={() => safeOpen(operation.borrowerSignUrl)} className="px-3 py-2 rounded-xl bg-blue-500/10 text-blue-400 text-[7px] font-black uppercase flex items-center gap-1"><ExternalLink size={11} /> Assinar como tomador</button>}
