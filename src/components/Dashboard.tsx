...
import { TrendingUp, Users, FileText, Activity, Calendar as CalendarIcon, Clock } from 'lucide-react';
import {
  effectiveLoanStatus,
...
const Dashboard: React.FC<DashboardProps> = ({ loans, dailyLateFeeRate, onNavigateToLoan }) => {
