...
const parseInterestOnlyRenewalRecord = (raw: unknown): InterestOnlyRenewalRecord | null => {
  ...
  return {
    ...
    interestPaid: toOptionalPositiveNumber(raw.interestPaid),
    lateFeePaid: toOptionalPositiveNumber(raw.lateFeePaid),
    lateFeeCarried: toOptionalPositiveNumber(raw.lateFeeCarried),
    totalPaid: toOptionalPositiveNumber(raw.totalPaid),
    paymentDate,
...
export const normalizeInstallment = (raw: unknown, fallbackNumber = 1): Installment => {
  ...
  return {
    ...
    carriedLateFee: toOptionalPositiveNumber(payload.carriedLateFee),
